...
const RelatedDoctors = ({ speciality, docId }) => {
  ...
  const [RelDoctors, setRelDocs] = useState([])
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      <h1 className="text-3xl font-medium">Los Mejores Medicos</h1>
      <p className="sm:w-1/3 text-center text-sm">
        Conoce a los médicos disponibles y encuentra al especialista ideal para
        ti.
      </p>
      <div className="max-w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0">
